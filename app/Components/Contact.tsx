  ...
  return (
    <div id='contact' className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        ...
        <h2 className="py-4 font-bold text-3xl  text-gray-800">Get In Touch</h2>
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full">
              ...
              <div>
                <h2 className="py-2 font-bold text-[25px] shadow-gray-800">
                Jasim Ali Rajput
                </h2>
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4">
                  ...
                  <Link target='_blank' href={"https://www.linkedin.com/in/jasim-amanat-a24a861b2/"}>
                    <GrLinkedinOption />
                    </Link>
                  </div>
                  ...
                  <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300">
                  <Link target='_blank' href={"mailto:Jasim.ali.rajput65@gmail.com"}>
                    <AiOutlineMail />
                    </Link>
                  </div>
        ...
        <div className="p-4">
            <form>
                ...
                <button className="w-full p-4 text-gray-100 mt-4 bg-[#5651e5] rounded-xl">Send Message</button>
            </form>
          </div>
        </div>
      </div>
